...
final class TestDay_4: XCTestCase {
...
"""
        let day = Day_4()
        let result = day.partOne(input: Day4Data(data: data))
    ...
    func testComputePartOne() {
        ...
        let day = Day_4()
        let result = day.partOne(input: Day4Data(data: input))
        XCTAssertEqual(result, 8442)
    }
...
"""
        let day = Day_4()
        let result = day.partTwo(input: Day4Data(data: data))
